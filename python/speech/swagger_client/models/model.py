...
class Model(object):
    ...
    def __init__(self, id=None, text=None, base_model=None, datasets=None, model_kind=None, name=None, description=None, properties=None, locale=None, last_action_date_time=None, status=None, created_date_time=None):  # noqa: E501
