...
class Endpoint(object):
    ...
    def __init__(self, concurrent_recognitions=None, id=None, endpoint_urls=None, endpoint_kind=None, last_action_date_time=None, status=None, created_date_time=None, models=None, content_logging_enabled=None, name=None, description=None, properties=None, locale=None):  # noqa: E501
